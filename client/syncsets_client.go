...
// NewHTTPClientWithConfig creates a new syncsets HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Syncsets {
...
// New creates a new syncsets client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Syncsets {
	// ensure nullable parameters have default
	if formats == nil {
